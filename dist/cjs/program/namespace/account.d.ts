...
export default class AccountFactory {
    static build<IDL extends Idl>(idl: IDL, coder: Coder, programId: PublicKey, provider?: Provider, skipDiscriminator?: boolean): AccountNamespace<IDL>;
}
...
export declare class AccountClient<IDL extends Idl = Idl, N extends keyof IdlAccounts<IDL> = keyof IdlAccounts<IDL>, A extends NullableIdlAccount<IDL> = NullableIdlAccount<IDL>, T = IdlAccounts<IDL>[N]> {
    ...
    get idlAccount(): A;
    private _idlAccount;
    private _skipDiscriminator;
    constructor(idl: IDL, idlAccount: A, programId: PublicKey, provider?: Provider, coder?: Coder, skipDiscriminator?: boolean);
    /**
