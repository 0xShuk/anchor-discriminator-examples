...
class NamespaceFactory {
    ...
    static build(idl, coder, programId, provider, getCustomResolver, skipDiscriminator) {
        ...
        const account = idl.accounts
            ? account_js_1.default.build(idl, coder, programId, provider, skipDiscriminator)
            : {};
        idl.instructions.forEach((idlIx) => {
            const ixItem = instruction_js_1.default.build(idlIx, (ixName, ix) => coder.instruction.encode(ixName, ix), programId, skipDiscriminator);
