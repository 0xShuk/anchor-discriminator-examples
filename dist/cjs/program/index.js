...
class Program {
    ...
    constructor(idl, programId, provider, coder, getCustomResolver, skipDiscriminator) {
        ...
        // Dynamic namespaces.
        const [rpc, instruction, transaction, account, simulate, methods, views] = index_js_2.default.build(idl, this._coder, programId, provider, getCustomResolver !== null && getCustomResolver !== void 0 ? getCustomResolver : (() => undefined), skipDiscriminator);
        this.rpc = rpc;
