...
export declare class Program<IDL extends Idl = Idl> {
     ...
     */
    constructor(idl: IDL, programId: Address, provider?: Provider, coder?: Coder, getCustomResolver?: (instruction: IdlInstruction) => CustomAccountResolver<IDL> | undefined, skipDiscriminator?: boolean);
    /**
